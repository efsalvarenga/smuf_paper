...
On both forecast lead-times the SS functions (Seasonal Similarity where $r = 1$, and Seasonal & Remainder where $r=0.5$) perform poorly compared to the alternatives.
